...
describe('QuestDomainService - Station Resources Integration', () => {
  ...
  beforeEach(() => {
    ...
    monsterService = TestBed.inject(
      MonsterService
    ) as jest.Mocked<MonsterService>;
  ...
  describe('Station Resource Generation', () => {
    it('should accumulate goo from successful encounters', () => {
      ...
      monsterService.generateMultiMonsterEncounter.mockReturnValue([
        mockMonster
      ]);
    ...
    it('should scale resources with hero level', () => {
      ...
      for (let i = 0; i < 10; i++) {
        ...
        const lowLevelStep = service.generateNextStep(
          lowLevelHero,
          lowLevelContext
        );
        ...
        const highLevelStep = service.generateNextStep(
          highLevelHero,
          highLevelContext
        );
